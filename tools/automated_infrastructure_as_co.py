...
Perform static analysis on Terraform, CloudFormation, and Kubernetes manifest files to identify security misconfigurations such as exposed ports, weak IAM policies, unencrypted storage, and non-compliant settings. Integrates with popular OSS tools like Checkov or tfsec to provide a unified CloudVAPT scanning interface for development pipelines.
"""
